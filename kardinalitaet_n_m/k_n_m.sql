...
-- Detailtabelle: Servants - ohne Fremdschlüssel
...
-- Detailtabelle: Servants - Struktur

DESCRIBE design.servants;


-- Detailtabelle: Servants: Inserts
...
-- Detailtabelle: Servants: Inhalte
SELECT * FROM design.servants;

/*  PRODUCTS */

-- Detailtabelle: Products - ohne Fremdschlüssel
...
-- Detailtabelle: Products - Inserts
...
-- Detailtabelle: Products - Struktur
